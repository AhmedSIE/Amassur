...
class Attestations extends React.Component {
    ...
    attestations=(attestation)=>{
        this.setState({modalVisible:true,attestation:attestation});
    }
    ...
    fetchListData = async () => {
        this.setState({ attestations: this.props.route.params.attestations,loading:false});
    };
    ...
    render() {
        return (
            <View style={{flex:1}}>
                {
                    this.state.loading ? (
                        <AppLoading titreMessage={'Attestations en cours de chargement ...'}/>
                    ):(
                        <View style={styles.safeArea}>
                            <FlatList
                                data={this.state.attestations}
                                ...
                                >
                                    <View style={styles.contrat}>
                                        <SafeAreaView style={styles.modalView}>
                                            { 
                                                <WebView
                                                    source={{ uri: "http://192.168.1.123:8000/storage/"+this.state.contrat}}
