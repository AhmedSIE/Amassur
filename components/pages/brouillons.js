...
class Messages extends React.Component{
    ...
    lesmessages = async()=>{
        await fetch('http://192.168.1.111:8000/api/messages/message',{
            method:'post',
            headers:{
    ...
    onSend = async() => {
        if (this.state.message!='') {
            await fetch('http://192.168.1.111:8000/api/messages/message/save',{
                method:'POST',
                headers:{
                    'Accept':'application/json',
                    'Content-Type':'application/json'
    ...
    render(){
        ...
        return (
            <View style={styles.container}>
                ...
                {/* <Text style={styles.textsms}>Amassur</Text> */}
